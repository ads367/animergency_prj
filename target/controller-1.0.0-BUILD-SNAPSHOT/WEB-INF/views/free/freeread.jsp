...
<body>
	...
	<header class="masthead"
		style="background-image: url('${ pageContext.request.contextPath }/resources/img/freeboard.gif')">
			...
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="page-heading">
						<h1>Free Board</h1>
						<span class="subheading">AniMergency의 자유게시판</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-10 mx-auto">
				...
				<table class="table" style="width: 100%; margin-bottom: 1rem;">
					<thead>
						<tr
							style="border-bottom: 3px solid thead-dark; color: darkslategray; width: 5%;">
							<th
								style="border-top: none; border-right: thead-dark; width: 5%;">${freeread.fIDX }</th>
							<th style="border-top: none; text-align: center;">${freeread.fTitle }</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td
								style="border: none; text-align: right; width: 95%; font-size: small; padding-bottom: 0px;">작성자:${freeread.userId }&nbsp;&nbsp;조회수:
								${freeread.fCount }</td>
						</tr>
						...
						<tr>
							<td style="border: none; width: 5%;"></td>
							<td
								style="border: none; text-align: right; width: 95%; font-size: small; padding: inherit;">${freeread.fDate }&nbsp;&nbsp;&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"
								...
								${fn:replace(freeread.fContent, newLineChar, "<br/>")}
						</tr>
					</tbody>
				</table>
				...
				<p align="right">
					<button type="button"
						onclick="location.href='${ pageContext.request.contextPath }/free/free'"
						class="btn btn-outline-secondary" style="font-size: small;">목록으로</button>
					<c:if test="${ sessionUserId eq freeread.userId }">
						<button type="button"
							onclick="location.href='${ pageContext.request.contextPath }/free/freeupdate?fIDX=${freeread.fIDX }'"
							class="btn btn-outline-secondary" style="font-size: small;">수정하기</button>
						<button type="button" class="btn btn-outline-secondary"
							style="font-size: small;" onclick="fDeleteCancle()">삭제하기</button>
					</c:if>
				</p>
			</div>
		</div>
...
<script>
	function fDeleteCancle() {
		var idx = ${freeread.fIDX};
		var deleteCancel = confirm('정말로 삭제하시겠습니까?');
		if (deleteCancel == true) {
			location.href = "${ pageContext.request.contextPath }/free/freedelete?fIDX="+ idx;
		}
	}
</script>
