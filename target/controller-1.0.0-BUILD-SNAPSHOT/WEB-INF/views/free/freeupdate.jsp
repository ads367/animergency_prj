...
<body>
   ...
   <div class="container" style="margin-top: 100px;">
      <form action="${ pageContext.request.contextPath }/free/freeupdateAction" method="post">
         <div class="row">
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                  ...
                  <tbody>
                     <tr style="background-color: #343a40;">
                        <td style="border-right: inset; color: white;">
                           제목
                           <input type="hidden" name="fIDX" value="${ freeupdate.fIDX }">
                        </td>
                        <td><input type="text" name="fTitle"
                           style="width: 99%; border: 2px;" autofocus="autofocus"
                           value="${freeupdate.fTitle }" /></td>
                     </tr>
                     <tr>
                        <td style="border-right: inset;"></td>
                        <td><input type="text" name="userId"
                           value="작성자 :${freeupdate.userId}" readonly="readonly"
                     ...
                     <tr>
                        ...
                        <td style="border-top: none; border-bottom: groove;"><textarea
                              name="fContent"
                              style="width: 100%; height: 350px; border: 2px;">${freeupdate.fContent}</textarea>
                        </td>
                     </tr>
                  </tbody>
               </table>
               ...
               <p align="right">
                  ...
                  <button type="button" class="btn btn-outline-secondary"
                     style="font-size: small;" onclick="fUpdateCancel()">수정취소</button>
               </p>
            </div>
         </div>
...
<script>
   function fUpdateCancel() {
      var idx = ${freeupdate.fIDX};
      var updateCancel = confirm('수정을 취소하시겠습니까?');
      if (updateCancel == true) {
         location.href = "${ pageContext.request.contextPath }/free/freeread?fIDX=" + idx;
      }
   }
</script>
