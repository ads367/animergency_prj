...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav" style="background-color: slategrey;">
		<div class="container">
	...
	<div class="container" style="margin-top: 100px;">
		<form action="${ pageContext.request.contextPath }/free/freewrite"
			method="post" id="frm" onclick="return false;">
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">


					<table class="table table-striped" id="free">
						<tbody>
							<tr style="background-color: #343a40;">
								...
								<td><input type="text" name="fTitle" id="write_fTitle"
							...
							<tr>
								...
								<td style="border-bottom: groove;"><textarea
										name="fContent" id="write_fContent"
					...
					<p align="right">
						<button type="submit" class="btn btn-outline-secondary"
							onclick="freeWriteCheck()" style="font-size: small;">작성완료</button>
						<button type="button"
...
<script>
	function freeWriteCheck() {
		if ($("#write_fTitle").val() == "") {
			$("#write_fTitle").focus();
			alert("제목을 입력하세요.");
			return false;
		} else if ($("#write_fContent").val() == "") {
			$("#write_fContent").focus();
			alert("내용을 입력하세요.");
			return false;
		} else {
