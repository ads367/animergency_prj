...
<link href="${ pageContext.request.contextPath }/resources/vendor/fontawesome-free/css/all.min.css?ver=2"
   ...
   <div class="container">
            ...
            <tbody>
               <c:forEach var="map" items="${ list }">
                  <tr style="text-align:center;">
                     <td>${map.fIDX }</td>
                     <td><a href="${ pageContext.request.contextPath }/free/freeread?fIDX=${map.fIDX}">${map.fTitle }</a></td>
                     <td>${map.userId }</td>
                     <td>${map.fDate }</td>
                     <td>${map.fCount }</td>
                  </tr>
      ...
      <p align="right">
         <button type="button" class="btn btn-outline-secondary"
            ...
            onclick="location.href='${ pageContext.request.contextPath }/free/freewrite'">글쓰기</button>
      </p>
   </div>
