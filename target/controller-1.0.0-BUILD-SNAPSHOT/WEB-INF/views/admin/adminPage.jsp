		...
		<c:forEach var="vo" items="${ gradeList }">
			<div class="panel panel-default">
				<div class="panel-heading">
					ID : ${ vo.userId } | Name : ${ vo.userName } | Date : ${ vo.gradeDate } | GradeApply : ${ vo.userGrade }
					<p style="text-align: right">
						<button class="btn btn-outline-primary" type="button" onclick="location.href='${ pageContext.request.contextPath }/admin/deleteAction?userId=${vo.userId}'">수락</button>
						<button class="btn btn-outline-danger" type="button" onclick="location.href='${ pageContext.request.contextPath }/admin/deleteAction?userId=${vo.userId}'">거절</button>
					</p>
				</div>
				<div class="panel-body">${ vo.applyContent }</div>
			</div>
		</c:forEach>
	</div>
</div>
