...
<body>
	...
	<div class="container" style="margin-top: 100px;">
		<form action="${ pageContext.request.contextPath }/qa/qawrite"
				...
				<div class="col-lg-8 col-md-10 mx-auto">
					...
					<table class="table table-striped" id="free">
						<tbody>
							<tr style="background-color: pink;">
								...
								<td><input type="text" name="qTitle" id="write_qTitle"
							...
							<tr>
								...
								<td style="border-bottom: groove;"><textarea
										name="qContent" id="write_qContent"
					...
					<p align="right">
						<button type="submit" class="btn btn-outline-danger"
							onclick="qaWriteCheck()" style="font-size: small;">작성완료</button>
						<button type="button"
...
<script>
	function qaWriteCheck() {
		if ($("#write_qTitle").val() == "") {
			$("#write_qTitle").focus();
			alert("제목을 입력하세요.");
			return false;
		} else if ($("#write_qContent").val() == "") {
			$("#write_qContent").focus();
			alert("내용을 입력하세요.");
			return false;
		} else {
