...
<body>
	...
	<div class="container" style="margin-top: 100px;">
		<form
			action="${ pageContext.request.contextPath }/training/tnupdateAction"
			method="post">
			<div class="row">
				...
				<div class="col-lg-8 col-md-10 mx-auto">
					...
					<table class="table" id="free">
						<tbody>
							<tr style="background-color: darkslategray;">
								<td style="border-right: inset; color: white;">제목 <input
									type="hidden" name="tIDX" value="${ tnupdate.tIDX }">
								</td>
								<td><input type="text" name="tTitle"
									style="width: 99%; border: 2px;" autofocus="autofocus"
									value="${tnupdate.tTitle }" /></td>
							</tr>
							<tr>
								<td style="border-right: inset;"></td>
								<td><input type="text" name="userId"
									value="작성자 :${tnupdate.userId}" readonly="readonly"
							...
							<tr>
								...
								<td style="border-top: none; border-bottom: groove;"><textarea
										name="tContent"
										style="width: 100%; height: 350px; border: 2px;">${tnupdate.tContent}</textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<p align="right">
						...
						<button type="button" class="btn btn-outline-info"
							style="font-size: small;" onclick="tnUpdateCancel()">수정취소</button>
					</p>
...
<script>
	function tnUpdateCancel() {
		var idx = ${tnupdate.tIDX};
		var updateCancel = confirm('수정을 취소하시겠습니까?');
		if (updateCancel == true) {
			location.href = "${ pageContext.request.contextPath }/training/tnread?tIDX="+ idx;
		}
	}
</script>
